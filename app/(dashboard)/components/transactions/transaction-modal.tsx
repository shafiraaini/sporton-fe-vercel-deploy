    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title="Verify transactions">
            <div className="flex gap-6">
                ...
                <div>
                    <h4 className="font-semibold text-sm mb-2 mr-2">Order Details</h4>
                    <div className="bg-gray-100 rounded-md flex flex-col gap-2.5 p-6 text-sm mb-5">
                    ...
                    <div className="border border-gray-200 rounded-lg p-2 flex items-center gap-2">
                        <div className="bg-gray-100 rounded aspect-square w-8 h-8">
                            <Image src="/images/products/product-1.svg" width={30} height={30} alt="product image"/>
                        </div>
